...
describe('ProcessListCloudExtComponent With Custom Columns', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [NoopAnimationsModule, NoopTranslateModule, ProcessCloudModule, ProcessListCloudExtComponent],
            declarations: [MockCustomProcessStatusComponent, MockCustomProcessNameComponent],
            providers: [provideMockStore()],
        });
