...
import { AppConfigService, AppConfigServiceMock, AuthenticationService, RedirectAuthService } from '@alfresco/adf-core';
import { PendoService, PendoWindow } from './pendo.service';
...
describe('PendoService', () => {
    ...
    it('should initialize pendo service', () => {
        ...
        expect((<PendoWindow>(<unknown>window))['pendo']).toBeTruthy();
    });
